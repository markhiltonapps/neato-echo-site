---
title: Your hotkeys
description: Neato Echo has five separate shortcuts, not one. Here's what each does, what it defaults to, and how to change or unbind it.
---
Neato Echo listens for **five separate shortcuts**, each starting a different
...
The dictation shortcut is set for you on first run: **Ctrl+Win**. Tap it to
start and stop, or hold it while you speak — see [hold or
tap](/help/dictation/hold-or-tap).
...
settings, **Tap** and **Hold**. Tap is the default. [Hold or
tap](/help/dictation/hold-or-tap) has the detail.
